...
extension SingnUpViewController: UINavigationControllerDelegate, UIImagePickerControllerDelegate{
    
    func openGallery(){
        print("photo savedPhotosAlbum")
        if UIImagePickerController.isSourceTypeAvailable(.savedPhotosAlbum){
            print("picker UIImagePickerController")
